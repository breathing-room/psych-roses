...
const Header = () => {
  ...
  return (
    <div class="h-full z-50">
      ...
      <div class="flex">
       <button onClick={() => toggleExpansion(!isExpanded) } class={`hover:bg-red-400 md:fixed top-0 left-0 m-0` }>
      ...
      {/* Logo */}
      <div class="flex justify-center pt-0 md:pt-3 pb-10 md:mb-10 md:pb-0">
      ...
      {/* Sidebar */}
      <div class={`h-100 w-full md:w-80 bg-gray-900
