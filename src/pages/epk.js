      ...
      <div class="flex bg-gray-900 text-justify">
        <div class="flex flex-col w-9/10 justify-between">
          ...
          <div class="">
            ...
            <p class='m-5'>Their inimitable, soulful vocals with 4-part harmonies and demented musical palette melds elegance and ferocity, coalescing into a singular genre that weaves doo-wop and glitter-gore with a psychedelic surf/punk edge.</p>
            <p class='m-5'>Band leader and producer Tasche de la Rocha began her music career as a teen on the streets of New Orleans, and quickly found recognition for her rare sound, being invited to play solo house concerts for Laurie Anderson and Jennifer Coolidge. In her acclaimed debut album <a href="https://open.spotify.com/album/1c5wv4ZOmfz6mRtcI2pUw4">Gold Rose</a>, Tasche collaborated with Joseph Faison, out of which grew the full 8-piece band Psychedelic Roses. </p>
        ...
        <div class="flex flex-col items-center">
          ...
          <div class="flex">
            ...
            <div class="flex flex-col self-center">
              <h4 class=' text-lg text-red-400 font-bold'>What folks are saying...</h4>
