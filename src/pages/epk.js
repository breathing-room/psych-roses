  ...
  return (
    <Layout>
      ...
      <div className="flex-col md:flex-row lg:flex text-justify">
        <div className="flex flex-col w-9/10 justify-between">
          {/* Bio */}
          <div className="bg-gray-900">
            ...
            <p className="m-5">
              ...
              {' '}
              deploy four part vocal harmonies, grunge guitar riffs, and elements of punk, doo wop, surf, cabaret, and psychedelia, all the while swaying on a thin wire between sweetness and destruction.
            </p>
            ...
            <p className="m-5">
              Tasche began her music career as a teen busking solo on the streets of New Orleans, and quickly found recognition for her singular voice and guitar sound, even being invited to play solo house concerts for Laurie Anderson and Jennifer Coolidge. On her acclaimed solo debut album, 2016’s
              <i>Gold Rose</i>
              , Tasche collaborated with Joseph Faison, out of which grew the full eight-piece band the Psychedelic Roses.
            </p>
            <p className="m-5">Tasche and the Psychedelic Roses’ self-titled album will be released in August 2022 on New Orleans label Sinking City Records. It was recorded at the Studio In The Country in Bogalusa and Wixmix in New Orleans, and is produced by Tasche de la Rocha and Eric Heigle. Heigle, who also engineered the album, is known for his work with Arcade Fire, Dr. John, 79rs Gang, Soul Rebels, and Lost Bayou Ramblers, amongst others.</p>
            <p className="m-5">Tasche and the Psychedelic Roses rock with a wild abandon and channel a feminist alchemy. It’s a soundtrack for the moment - make out sessions, quiet contemplation, and fighting the demons around us.</p>
          </div>
          {/* Video */}
          ...
          {/* Contact */}
          <div className="bg-gray-900 flex-col w-full self-center items-center">
            <h4 className="m-5 text-lg text-red-400 font-bold">How to get in touch</h4>
            <p className="m-5">taschedelarochamusic@gmail.com</p>
          </div>
        </div>
        <div className="flex flex-col items-center">
          ...
          <div className="m-2 md:flex">
            ...
            <div className="bg-gray-900 py-2">
              ...
              <p className="m-5">
                Full of complexity, dark musings, whimsy, and rib pokes at redemption, Tasche and The Psychedelic Roses' new album escorts us
              ...
              <p className="m-5">In The Abyss, there's always a party in progress, with Tasche and The Psychedelic Roses taking the stage."</p>
